...
var propTabs = {
	primer_encabezado: document.getElementById('encabezado_ConyRec').firstElementChild,
	primer_contenido: document.getElementById('contenido_ConyRec').firstElementChild,
	enlaces_encabezado: document.querySelectorAll('#encabezado_ConyRec li a'),
	li_encabezado: document.querySelectorAll('#encabezado_ConyRec li'),
	divs_contenido: document.querySelectorAll('#contenido_ConyRec > div'),
