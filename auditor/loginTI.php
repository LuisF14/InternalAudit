...
<body class="body_login"> 
        <form class="formloaud" id="envialoaudTI" name="envialoaudTI" action="../controller/actionLoginTI.php" method="post">
        <h1>Login TI</h1>
        ...
        <div class="formulario-grupo">
            <input type="hidden" name="envialoaudTI">
            <button type="submit" class="button">INGRESAR</button>           
            <p style="text-align: center;"><a href="login.php" style="text-decoration: none;color: #424242;">Login Auditor</a></p>
            ...
            <p style="text-align: center;"><a href="registroTI.php" style="text-decoration: none;color: #424242;">Registrarse</a></p>       
        </div>
        </form>
    ...
    <script src="../js/LoginTI.js"></script>
